...
T_max (max_tokens) and the optional large vocabulary stay off until the
...
from validity_common.identities import Architecture, FreeKnobs, derive_architecture
from validity_common.protocol_defaults import MIN_SEQ_LEN
