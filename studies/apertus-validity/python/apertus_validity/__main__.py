"""Command-line entry: python -m apertus_validity ..."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Apertus validity study: sample subjects and collect measurements."
    )
...
def _add_shared(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--include-large-vocab",
        action="store_true",
        help="add vocab_size=131072 to the catalog",
    )
