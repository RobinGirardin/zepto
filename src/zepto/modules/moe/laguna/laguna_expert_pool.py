"""Laguna routed SwiGLU expert pool."""
...
class LagunaExpertPool(Module):
    """Unrolled SwiGLU experts with gather/scatter dispatch."""

    module_kind = "LagunaExpertPool"
