"""Elementwise sigmoid operation declaration."""
...
_SIGMOID_FLOPS_PER_ELEMENT = 4


class Sigmoid(Operation):
    """Apply an elementwise sigmoid: σ(x) = 1 / (1 + exp(-x))."""
    ...
    def forward_flops(self, context: EstimationContext) -> int:
        ...
        return _SIGMOID_FLOPS_PER_ELEMENT * numel(output)
