"""Elementwise hyperbolic tangent operation declaration."""
...
_TANH_FLOPS_PER_ELEMENT = 4


class Tanh(Operation):
    """Apply an elementwise hyperbolic tangent."""
    ...
    def forward_flops(self, context: EstimationContext) -> int:
        ...
        return _TANH_FLOPS_PER_ELEMENT * numel(output)
